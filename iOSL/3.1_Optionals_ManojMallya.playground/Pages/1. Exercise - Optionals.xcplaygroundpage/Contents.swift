...
print("ERROR: force-unwrap using '!' to abort execution if the optional value contains 'nil'")
...
let userAge: Int? = Int(userInputAge)
print("Its because the userInputAge doesnt store Int value.")
 ...
 */
let userInputAge1: String="123"
let userAge1: Int? = Int(userInputAge1)
print(userAge1)

let userInputAge2: String?="123"
