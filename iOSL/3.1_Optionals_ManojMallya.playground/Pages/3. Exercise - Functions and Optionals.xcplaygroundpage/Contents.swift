...
//updated above... return type has been set to Int? and nil cases are well handled
//checkAge(age: userInputAge)
//var result:Int? = checkAge(age: "23")
print("Returned Value: \(checkAge(userInputAge: userInputAge))")
