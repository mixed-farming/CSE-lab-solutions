...
// The above print statement will produce a complie error as var foo's scope is limited only to the for loop
...
// The above pront statements will complie as var x is declared in the global scope and therefore accessable to all functions and loops.
...
greeting(greeting: "Hi there", name: "Manoj")
greeting(greeting: nil, name: "Mayur")
