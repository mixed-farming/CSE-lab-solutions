...
//    var heightInCentimeters: Double
    var heightInCentimeters: Double{
        didSet{
            print("Value of height set to: \(oldValue)")
        }
    }
...
var height=Height(heightInCentimeters: 172)
...
//    var maxMarks: Int
//    var securedMarks: Int
//    var percentage: Int {
//        (securedMarks/maxMarks) * 100
//    }
//}
//
//let student1=Student(listOfSubjects: [(Subject(subjectName: "Maths", subjectCode: "CSE1022", maxMarks: 50, securedMarks: 47)),(Subject(subjectName: "Science", subjectCode: "CSE1024", maxMarks: 50, securedMarks: 41))])
//print(student1.listOfSubjects)
/*:
