...
insert into EMPLOYEE(emp_no,emp_name,gender,salary,address,dno) values(1,'Manoj','m',100000,'Manipal','102');

insert into EMPLOYEE(emp_no,emp_name,gender,salary,address,dno) values(2,'Mayur','m',100000,'Manipal','103');

insert into EMPLOYEE(emp_no,emp_name,gender,salary,address,dno) values(3,'Mahesh','m',100000,'Manipal','104');

5.)

insert into EMPLOYEE(emp_no,emp_name,gender,salary,address,dno) values(1,'Manoj','m',100000,'Manipal','102');

insert into EMPLOYEE(emp_no,emp_name,gender,salary,address,dno) values(1,'Mayur','m',100000,'Manipal','103');

insert into EMPLOYEE(emp_no,emp_name,gender,salary,address,dno) values(1,'Mahesh','m',100000,'Manipal','104');
